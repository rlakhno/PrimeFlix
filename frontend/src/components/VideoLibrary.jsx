...
const VideoLibrary = () => {
  const videos = [
    { id: 1, title: 'zoo', url: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4' },
    { id: 2, title: 'good news', url: 'https://www.youtube.com/watch?v=jNQXAC9IVRw' },
